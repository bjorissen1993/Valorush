...
export const MAP_DEFINITIONS: MapDefinition[] = [
  ...
  { id: "Corrode", splashFile: null, pools: ["competitive"] },
  ...
  { id: "Summit", splashFile: null, pools: ["competitive", "retake"] },
...
/** Competitive maps with splash assets only (Summit/Corrode excluded until images added). */
